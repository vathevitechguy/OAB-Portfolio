...
//     readyPromise.then(() => {
//       previewFile('pdf-div', {});
//       previewFileUsingFilePromise('pdf-div', filePromise, 'sample.pdf');
    ...
    const previewFilePromise = this.adobeDCView.previewFile(
      {
        ...
        content: {
          ...
          location: {
            url: 'https://drive.google.com/file/d/1Yu1ZEXd6I6ogPiB2JSIfjWxaLG326Ehd/view',
            /*
